  ...
  const fetchSejarahData = async () => {
    try {
      ...
      if (result.success && result.data) {
        ...
        setContent(sejarahData);
        setEditContent(sejarahData);
      }
    } catch (error) {
      console.error("Error fetching sejarah data:", error);
      alert("Gagal mengambil data sejarah");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-4">
          <button
            ...
            className={`flex items-center text-[1.4rem] gap-2 px-4 py-2 rounded-lg transition-colors cursor-pointer text-gray-700 ${
            ...
            <>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  placeholder="Masukkan isi sejarah sekolah..."
                />
              </div>
            </>
          )}
